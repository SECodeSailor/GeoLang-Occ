    ...
    while epoch < max_num_epochs:
        ...
        for i_iter, data in enumerate(train_dataset_loader):
            ...
            if i_iter % print_freq == 0 and local_rank == 0:
                ...
                pred_list = []
                final_prediction = loss_input['pred_occ'][-1].argmax(dim=1)
                for i in range(18):
                    temp = torch.sum(final_prediction == i).item()
                ...
                logger.info('pred_occ:{}'.format(pred_list))
                detailed_loss = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--work-dir', type=str, default='/home/dgg/haiyang/occ/gs_2_rwkv/nuscenes_output_9_1105_no_hierarchical_cross_attn')
